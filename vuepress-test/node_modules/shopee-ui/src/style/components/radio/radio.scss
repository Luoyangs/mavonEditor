...
$radio-indicator-border-color: $gray-4;
$radio-disabled-bg-color: $gray-3;
$radio-disabled-border-color: $gray-5;
$radio-disabled-text-color: $gray;
...
.shopee-radio {
  ...
  &__input {
    ...
    &:checked + .shopee-radio__indicator {
  ...
  &.disabled {
    ...
    .shopee-radio__input:checked + .shopee-radio__indicator {
      background-color: $primary-color;
      border-color: $primary-color;
      opacity: .5;
    }
